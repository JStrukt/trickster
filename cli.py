...
TESTABLE_FILES = ["trickster", "app.py", "cli.py"]
...
@click.option(
    "-x",
    "--prefix",
    default=Config.DEFAULT_INTERNAL_PREFIX,
    help="Url prefix of internal endpoints.",
)
@click.option(
    "-r",
    "--routes",
    type=click.Path(exists=True),
    help="Path to json file with default routes.",
)
