...
def main() -> None:
    ...
    setup(
        ...
        version=get_version(),
        python_requires=">=3.8",
        description="Trickster is a Python/Flask application for mocking REST APIs",
        ...
        packages=["trickster"],
        install_requires=["click", "gunicorn", "flask", "fastjsonschema", "basicauth"],
        extras_require={
            "dev": [
                "setuptools",
                "wheel",
        ...
        entry_points={"console_scripts": ["trickster=cli:cli"]},
    )
