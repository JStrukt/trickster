...
class TestInternalEndpoints:
    ...
    def test_add_minimal_route(self, client):
        response = client.post(
            ...
            json={
                "id": "route_id",
                "path": "/path",
                "responses": [{"id": "response_id", "body": "response_body"}],
            },
        )
    ...
    def test_append_route(self, client):
        client.post(
            ...
            json={
                "id": "route_id1",
                "path": "/endpoint1",
                "responses": [{"id": "response_id1", "body": "response_body1"}],
            },
        )
        ...
        client.post(
            ...
            json={
                "id": "route_id2",
                "path": "/endpoint2",
                "responses": [{"id": "response_id2", "body": "response_body2"}],
            },
        )
    ...
    def test_reset_routes(self, client):
        client.post(
            ...
            json={
                "id": "route1",
                "path": "/endpoint1",
                "responses": [{"id": "response1", "body": "response1"}],
            },
        )
    ...
    def test_update_route(self, client):
        client.post(
            ...
            json={
                "id": "route1",
                "path": "/endpoint1",
                "responses": [{"body": "response1"}],
            },
        )

        response = client.put(
            "/internal/routes/route1",
            json={
                "path": "/endpoint2",
                "responses": [{"id": "response2", "body": "response2"}],
            },
        )
        assert response.status_code == 201
    ...
    def test_call_route(self, client):
        client.post(
            ...
            json={
                "id": "route",
                "path": "/endpoint",
                "responses": [{"id": "response", "body": {"response": "data"}}],
            },
        )
    ...
    def test_call_one_route_from_multiple(self, client):
        client.post(
            ...
            json={
                "path": "/endpoint1",
                "responses": [{"id": "response", "body": {"response": "data1"}}],
            },
        )
        client.post(
            "/internal/routes",
            json={
                "path": "/endpoint2",
                "responses": [{"id": "response", "body": {"response": "data2"}}],
            },
        )
    ...
    def test_route_doesnt_match_when_it_runs_out_of_responses(self, client):
        client.post(
            ...
            json={
                "path": "/endpoint",
                "responses": [{"repeat": 1, "body": {"response": "data1"}}],
            },
        )
        client.post(
            "/internal/routes",
    ...
    def test_get_route(self, client):
        client.post(
            ...
            json={
                "id": "route_id",
                "path": "/endpoint",
                "responses": [{"id": "response_id", "body": "response"}],
            },
        )
    ...
    def test_get_responses(self, client):
        client.post(
            ...
            json={
                ...
                "path": "/endpoint",
                "responses": [
                    {"id": "response_id1", "body": "response1"},
                    {"id": "response_id2", "body": "response2"},
                ],
            },
        )
    ...
    def test_get_response(self, client):
        client.post(
            ...
            json={
                "id": "route_id",
                "path": "/endpoint",
                "responses": [{"id": "response_id1", "body": "response1"}],
            },
        )
    ...
    def test_get_response_not_found(self, client):
        client.post(
            "/internal/routes",
            json={"id": "route_id", "path": "/endpoint", "responses": []},
        )
    ...
    def test_call_route_authentication_error(self, client):
        response = client.post(
            ...
            json={
                "id": "route_id",
                "path": "/path",
                "auth": {"method": "hmac", "key": "secret_key"},
                "responses": [{"id": "response_id", "body": "response_body"}],
            },
        )
    ...
    def test_reset(self, client):
        client.post(
            "/internal/routes",
            json={"path": "/path", "responses": [{"body": "response_body"}]},
        )
